  ...
  if (!pythonWorkerUiState.jobId && !pythonWorkerUiState.busy) {
    pythonWorkerSetText(
      ...
      profiles.length
        ? (
            pythonWorkerUiState.workerOnline === true
              ? 'Worker UI v153 · Выбрано FB-профилей: ' + profiles.length + '. Готово к Add BM.'
              : 'Worker UI v153 · Выбрано FB-профилей: ' + profiles.length + '. Жду READY от worker.'
          )
        : 'Worker UI v153 · Выберите FB-профили в Workspace.'
    );
  }
}
