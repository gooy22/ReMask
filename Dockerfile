...
COPY railway-cookie-token-probe.php /tmp/railway-cookie-token-probe.php
...
RUN set -eux; \
    ...
    cp /tmp/railway-cookie-token-probe.php /var/www/html/bin/remask-cookie-token-probe.php; \
    mkdir -p /var/www/html/bin; \
