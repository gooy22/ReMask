...
RUN /opt/remask-venv/bin/python -m compileall -q /opt/remask-python \
    ...
    && grep -q 'scope_selector_footer_v5_exact_envelope' /opt/remask-python/app/facebook_business_create.py \
    ...
    && grep -q 'scope_selector_footer_v5_exact_envelope' /opt/remask-python/main.py \
